...
use actix_web::{post,get,web, HttpServer, App, HttpResponse, Responder};
use clap::Parser;
...
async fn get_device_command(
    device_id: web::Path<String>) -> impl Responder {
    //not implemented
...
async fn get_group_configuration(
    group_id: web::Path<String>) -> impl Responder {
    return HttpResponse::NotImplemented().body("Not implemented");
}
#[post("/v1/management/groups/{group_id}")]
async fn post_group_configuration(
    group_id: web::Path<String>) -> impl Responder {
    return HttpResponse::NotImplemented().body("Not implemented");
}
...
async fn get_event_configuration(
    event_type: web::Path<String>) -> impl Responder {
    return HttpResponse::NotImplemented().body("Not implemented");
}
#[post("/v1/management/events/{event_type}")]
async fn post_event_configuration(
    event_type: web::Path<String>) -> impl Responder {
    return HttpResponse::NotImplemented().body("Not implemented");
}
